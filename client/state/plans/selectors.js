...
export function getPlanPriceObject( state, productId, isMonthly = false ) {
	...
	//the server should probably do this, but formatted price comes back in whole numbers.
	const testNumber = 0.1;
	const decimalMark = testNumber.toLocaleString && testNumber.toLocaleString().indexOf( ',' ) !== -1 ? ',' : '.';
